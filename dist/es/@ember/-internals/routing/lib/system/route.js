...
import { EMBER_METAL_TRACKED_PROPERTIES, EMBER_ROUTING_BUILD_ROUTEINFO_METADATA, } from '@ember/canary-features';
...
class Route extends EmberObject {
    ...
    */
    modelFor(_name) {
        let name;
        let owner = getOwner(this);
        let transition = this._router && this._router._routerMicrolib
